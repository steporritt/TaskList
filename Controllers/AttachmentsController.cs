...
namespace TaskList.Controllers
{
    public class AttachmentsController : Controller
    {
        ...
        public AttachmentsController(AP16Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FileName,FileExtension,FileData")] Attachment attachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FileName,FileExtension,FileData")] Attachment attachment)
        {
            if (id != attachment.Id)
            {
                return NotFound();
